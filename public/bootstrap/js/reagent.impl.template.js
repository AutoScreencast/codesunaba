...
var G__34596 = o;
goog.object.set(G__34596,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34728__delegate = function (args){
...
while (G__34732__i < G__34732__a.length) {G__34732__a[G__34732__i] = arguments[G__34732__i + 0]; ++G__34732__i;}
  args = new cljs.core.IndexedSeq(G__34732__a,0,null);
} 
return G__34728__delegate.call(this,args);};
G__34728.cljs$lang$maxFixedArity = 0;
G__34728.cljs$lang$applyTo = (function (arglist__34733){
var args = cljs.core.seq(arglist__34733);
...
var G__34609 = o;
goog.object.set(G__34609,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34739__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34740__i < G__34740__a.length) {G__34740__a[G__34740__i] = arguments[G__34740__i + 0]; ++G__34740__i;}
  args = new cljs.core.IndexedSeq(G__34740__a,0,null);
} 
return G__34739__delegate.call(this,args);};
G__34739.cljs$lang$maxFixedArity = 0;
G__34739.cljs$lang$applyTo = (function (arglist__34742){
var args = cljs.core.seq(arglist__34742);
return G__34739__delegate(args);
});
...
var G__34620 = props;
var G__34620__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34620,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34620);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34620__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34625 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34625,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34625;
}
})(),id_class);
...
var G__34630 = (cljs.core.count(argv) - first_child);
switch (G__34630) {
case (0):
...
var vec__34639 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34639,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34639,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34639,(2),null);
...
var temp__5739__auto___34776 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___34776 == null)){
} else {
var key_34777 = temp__5739__auto___34776;
(jsprops.key = key_34777);
}
...
var temp__5739__auto___34781 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___34781 == null)){
} else {
var key_34783 = temp__5739__auto___34781;
(jsprops.key = key_34783);
}
...
var temp__5739__auto___34789 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___34789 == null)){
} else {
var key_34790 = temp__5739__auto___34789;
(jsprops.key = key_34790);
}
...
var temp__5739__auto___34794 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___34794 == null)){
} else {
var key_34795 = temp__5739__auto___34794;
(jsprops.key = key_34795);
}
...
var temp__5739__auto___34799 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___34799 == null)){
} else {
var key_34801 = temp__5739__auto___34799;
(jsprops.key = key_34801);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34672_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__34672_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__34686 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34686,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34686,(1),null);
...
break;
default:
var G__34838 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__34839 = compiler;
v = G__34838;
compiler = G__34839;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template34706 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template34706 = (function (opts,id,fn_to_element,meta34707){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34706.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34708,meta34707__$1){
var self__ = this;
var _34708__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34706(self__.opts,self__.id,self__.fn_to_element,meta34707__$1));
}));

(reagent.impl.template.t_reagent$impl$template34706.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34708){
var self__ = this;
var _34708__$1 = this;
return self__.meta34707;
}));

(reagent.impl.template.t_reagent$impl$template34706.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34706.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34706.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34706.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34706.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta34707","meta34707",1697968944,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34706.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34706.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34706");

(reagent.impl.template.t_reagent$impl$template34706.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template34706");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34706.
 */
reagent.impl.template.__GT_t_reagent$impl$template34706 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template34706(opts__$1,id__$1,fn_to_element__$1,meta34707){
return (new reagent.impl.template.t_reagent$impl$template34706(opts__$1,id__$1,fn_to_element__$1,meta34707));
});

}

return (new reagent.impl.template.t_reagent$impl$template34706(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});

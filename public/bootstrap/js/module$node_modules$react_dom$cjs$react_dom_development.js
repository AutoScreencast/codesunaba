...
return baseProps}return baseProps}function resetContextDependencies(){lastContextWithAllBitsObserved=lastContextDependency=currentlyRenderingFiber=null;isDisallowedContextReadInDEV=!1}function pushProvider(providerFiber,nextValue){var context=providerFiber.type._context;push(valueCursor,context._currentValue,providerFiber);context._currentValue=nextValue;void 0!==context._currentRenderer&&null!==context._currentRenderer&&context._currentRenderer!==rendererSigil&&error$jscomp$0("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported.");
...
goog.provide("module$node_modules$react_dom$cjs$react_dom_development");
goog.global. module$node_modules$react_dom$cjs$react_dom_development=shadow.js.require("module$node_modules$react_dom$cjs$react_dom_development", {});
